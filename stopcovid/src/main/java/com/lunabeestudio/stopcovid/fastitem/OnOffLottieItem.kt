...
class OnOffLottieItem : BaseItem<OnOffLottieItem.ViewHolder>(
    R.layout.item_on_off_lottie, ::ViewHolder, R.id.item_on_off_lottie
) {
...
fun onOffLottieItem(block: (OnOffLottieItem.() -> Unit)): OnOffLottieItem = OnOffLottieItem().apply(block)