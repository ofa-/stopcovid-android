...
class ApiSmartWalletEngine(
    val displayExpDays: Int,
    val displayElgDays: Int,
) {
    fun toSmartWalletEngine(): Configuration.SmartWalletEngine {
        return Configuration.SmartWalletEngine(displayExpDays.days, displayElgDays.days)
    }
}